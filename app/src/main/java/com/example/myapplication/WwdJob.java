                  ...
                  for (int y = 0; y < InStockArray.length(); y++) {
                      ...
                      if (timeActiveTill!= "null") {
                          ...
                          for(String a:playerWotSingleton.bannedResources)
                            ...
                            // If resourse banned then continue
                            if(flagBanned)continue;
                          ...
                          //Уведомление
                          nH.createNotification(x, "Резерв " + StrReservName + " активирован.", timeString + " на " + action_time, percentOfReserve);
